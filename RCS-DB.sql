...
INSERT INTO APARTMENTS(APARTMENT_ID, ADDRESS, CITY, STATE, ZIP_CODE, GENDER_ID) VALUES (4, '11730 Plaza America Dr. #205', 'Reston', 'VA', '20190', 4);

INSERT INTO EMPLOYEES(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, APARTMENT_ID, GENDER_ID) VALUES (1, 'Human', 'Resources', 'human', 'resources', 4, 4);
INSERT INTO EMPLOYEES(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, APARTMENT_ID, GENDER_ID) VALUES (2, 'Xavier', 'Grogan', 'xavier', 'grogan', 2, 1);
INSERT INTO EMPLOYEES(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, APARTMENT_ID, GENDER_ID) VALUES (3, 'Jonathan', 'Lee', 'jonathan', 'lee', 2, 1);
INSERT INTO EMPLOYEES(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, APARTMENT_ID, GENDER_ID) VALUES (4, 'Ben', 'Webster', 'ben', 'webster', 1, 1);
INSERT INTO EMPLOYEES(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, APARTMENT_ID, GENDER_ID) VALUES (5, 'Aaron', 'Camm', 'aaron', 'camm', 1, 1);
INSERT INTO EMPLOYEES(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, APARTMENT_ID, GENDER_ID) VALUES (6, 'Mory', 'Keita', 'mory', 'keita', 1, 1);
INSERT INTO EMPLOYEES(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, APARTMENT_ID, GENDER_ID) VALUES (7, 'Bella', 'Rose', 'bella', 'rose', 3, 2);

INSERT INTO GROUPS(GROUP_ID, EMPLOYEE_ID_1) VALUES (1, 1);
INSERT INTO GROUPS(GROUP_ID, EMPLOYEE_ID_1, EMPLOYEE_ID_2) VALUES (2, 2, 3);
INSERT INTO GROUPS(GROUP_ID, EMPLOYEE_ID_1, EMPLOYEE_ID_2, EMPLOYEE_ID_3) VALUES (3, 4, 5, 6);
INSERT INTO GROUPS(GROUP_ID, EMPLOYEE_ID_1) VALUES (4, 7);